...
},{"./media/transcript.json":2,"react":160,"react-transcript-player":4}],2:[function(require,module,exports){
module.exports={
  ...
  "turns": [
    {
      ...
      "sentences": [
        ...
        "Wax-works weren\u0027t made to be looked at for nothing, no how!"
      ],
      "words": [
        {
          "text": "If",
    ...
    },
    {
      "speaker": 0,
      "sentences": [
        "I know what you\u0027re thinking about, but it isn\u0027t so, no how."
      ],
      "words": [
        {
          "text": "I",
...
module.exports = React.createClass({
  ...
  componentDidMount: function componentDidMount() {
    React.findDOMNode(this.refs.audio).addEventListener('timeupdate', this.handleTimeUpdate);
  },
  ...
  componentWillUnmount: function componentWillUnmount() {
    React.findDOMNode(this.refs.audio).removeEventListener('timeupdate', this.handleTimeUpdate);
  },
  handleTimeUpdate: function handleTimeUpdate() {
    this.props.onTimeUpdate(parseInt(React.findDOMNode(this.refs.audio).currentTime * 1000));
  },
  seek: function seek() {
    if (this.props.seekTime !== null) {
      React.findDOMNode(this.refs.audio).currentTime = this.props.seekTime / 1000;
    }
  },
  render: function render() {
    return React.createElement(
      'div',
      null,
      React.createElement('audio', { ref: 'audio', src: this.props.media, controls: true })
    );
  }
});
...
module.exports = React.createClass({
  ...
  handleTimeUpdate: function handleTimeUpdate(time) {
    if (this.state.seekTime !== null && Math.abs(time - this.state.seekTime) < 10) {
      this.setState({ time: time, seekTime: null });
    } else {
      this.setState({ time: time });
    }
  },
  handleSeekRequest: function handleSeekRequest(seekTime) {
...
},{"./audio":3,"./transcript":5,"react":160}],5:[function(require,module,exports){
'use strict';
...
TurnView = React.createClass({
  displayName: 'TurnView',
  render: function render() {
    var _this = this;

    var words = this.props.words.map(function (w) {
      return [React.createElement(WordView, { word: w,
        time: _this.props.time,
        onClick: _this.props.onWordClick
      }), ' '];
    });
    return React.createElement(
      'div',
...
module.exports = React.createClass({
  ...
  render: function render() {
    ...
    var turns = this.props.transcript.turns.map(function (t, i) {
      return React.createElement(TurnView, { key: 'turn-' + i,
        speaker: _this2.props.transcript.speakers[t.speaker],
        words: t.words,
        time: _this2.props.time,
        onWordClick: _this2.props.onSeekRequest });
    });
    return React.createElement(
      'div',
      null,
